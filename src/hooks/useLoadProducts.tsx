...
import { GET_PRODUCTS, GetProductResponseQueries, GetProductsVars } from '../pages/products/product_layout/connections';
...
export const useProductsLoader = ({
  ...
  const loadMoreProducts = useCallback(
    ...
    [hasMore, loading, isLoadingMore, fetchMore, categoryId, pageSize, sorting, dispatch]
  );
